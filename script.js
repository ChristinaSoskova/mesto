...
let edit = document.querySelector('.profile-intro__edit-button');
let saveBth = document.querySelector('.popup__save-button');
let closeBth = document.querySelector('.popup__icon');
let nameU = document.querySelector('.profile-intro__text-title');
let job = document.querySelector('.profile-intro__text-subtitle');
